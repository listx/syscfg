...
FILES
	Generate sums of FILES and print them to STDOUT. If a directory
...
-c FILE
	Read all sums found in FILE and verify them.

-h
	Show this page and exit (regardless of other parameters).
-v
	Show version number and exit (regardless of other parameters).
