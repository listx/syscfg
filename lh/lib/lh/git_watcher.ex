defmodule LH.GitWatcher do
  ...
  def handle_info(
    ...
    Logger.info("DROPPING MSG BECAUSE STATE IS STALE")
    # Drop all file change messages (including ones generated by ourselves) if
    # we're still dealing with a stale state. This is because the tick()
    # function is already in the middle of getting fresh Git stats.
    {:noreply, state}
  end
