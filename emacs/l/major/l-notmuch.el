(use-package notmuch
  ...
  (setq notmuch-saved-searches
      '((:key "i" :name "inbox" :query "tag:main and tag:inbox and (not (tag:ml or tag:nl or tag:archived))")
        ...
        ; Work account.
        (         :name "work.inbox" :query "tag:work and tag:inbox and (not (tag:ml or tag:nl or tag:archived))")
        ...
        (         :name "work.cloud-releng+bugs" :query "tag:cloud-releng+bugs")
        (         :name "work.louhi-github" :query "tag:louhi-github")
        (         :name "work.gke-kubernetes-production" :query "tag:gke-kubernetes-production")
        (         :name "work.gke-kubernetes-release-wg" :query "tag:gke-kubernetes-release-wg")
        (         :name "work.infra-releng+alerts" :query "tag:infra-releng+alerts")
        (         :name "work.infra-releng+cl" :query "tag:infra-releng+cl")
        (         :name "work.emacs-users" :query "tag:work and tag:emacs-users")
        (         :name "work.git" :query "tag:work and tag:git")
        (         :name "work.git-dev" :query "tag:work and tag:git-dev")
        (         :name "work.xmonad" :query "tag:work and tag:xmonad")
        (         :name "work.zsh-users" :query "tag:work and tag:zsh-users")
        (         :name "work.ganpati-auto" :query "tag:ganpati")
        (         :name "work.archived" :query "tag:work and tag:archived")
        (         :name "work.trash" :query "folder:work/trash")
        (         :name "work.spam" :query "folder:work/spam")
        ))
