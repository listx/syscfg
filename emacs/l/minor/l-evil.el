(use-package evil
	...
	(define-key evil-motion-state-map "H" 'evil-next-buffer)
	(define-key evil-motion-state-map "L" 'evil-prev-buffer)
	(define-key evil-motion-state-map (kbd "C-l") 'elscreen-next)
	(define-key evil-motion-state-map (kbd "C-h") 'elscreen-previous)
