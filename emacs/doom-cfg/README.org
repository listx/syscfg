...
non-destructively navigates, and =M-S-<letter>= moves things around. This is more
...
Interestingly, setting =ispell-dictionary= to ="en"= appears to bring in Australian
English on top of American English. Compare it against the "default" one that
gets created automatically with

#+begin_src bash
cd ~/syscfg/emacs/spell-fu
diff -u words_spell-fu-ispell-words-default.txt words_spell-fu-ispell-words-en.txt
#+end_src
