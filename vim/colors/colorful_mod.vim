...
hi lhpHeader1 term=UNDERLINE ctermfg=darkblue guifg=#1071CE guibg=#E3EFFF gui=bold
hi lhpHeader2 term=BOLD ctermfg=DarkRed gui=bold guifg=#cd5f00 guibg=#FCECE0
hi lhpHeader3 term=UNDERLINE ctermfg=red gui=bold guifg=#00881b guibg=#DBF8E3
hi lhpHeader4 term=BOLD ctermfg=darkgray guifg=SteelBlue guibg=#F0F6FF gui=bold
hi lhpHeader5 term=UNDERLINE ctermfg=red gui=bold guifg=#B91F49 guibg=#FFE3E5
hi link lhpHeader6 lhpHeader1
hi lhpHeader7 term=BOLD ctermfg=DarkRed gui=bold guifg=#F06F00 guibg=#FCECEE
hi link lhpHeader8 lhpHeader3
hi link lhpHeader9 lhpHeader2

hi link lhpHeaderPlaceholderBlank Normal

hi link lhpSection lhpHeader3
hi link lhpSectionMulti1 lhpSection
hi link lhpSectionMulti2 lhpSection
hi link lhpUSC lhpSection

hi link lhpBold Constant
...
hi lhpCite term=UNDERLINE ctermfg=red gui=underline guifg=#00881b guibg=#DBF8E3

hi lhpBullet1                   guifg=#4682b4
hi link lhpBullet2 lhpBullet1 
hi link lhpBullet3 lhpBullet1
hi lhpCount                     guifg=#4682b4
