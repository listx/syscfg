(define byeoru-on-key '("<IgnoreShift><Control>("))
(define byeoru-on-key? (make-key-predicate '("<IgnoreShift><Control>(")))
(define byeoru-latin-key '("<IgnoreShift><Control>("))
(define byeoru-latin-key? (make-key-predicate '("<IgnoreShift><Control>(")))
