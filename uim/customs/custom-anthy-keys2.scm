(define anthy-on-key '("zenkaku-hankaku" "<IgnoreShift><Control>("))
(define anthy-on-key? (make-key-predicate '("zenkaku-hankaku" "<IgnoreShift><Control>(")))
(define anthy-off-key '("zenkaku-hankaku" "<IgnoreShift><Control>("))
(define anthy-off-key? (make-key-predicate '("zenkaku-hankaku" "<IgnoreShift><Control>(")))
