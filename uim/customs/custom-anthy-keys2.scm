(define anthy-on-key '("zenkaku-hankaku" "<Shift> " "<IgnoreShift><Control>("))
(define anthy-on-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "<IgnoreShift><Control>(")))
(define anthy-off-key '("zenkaku-hankaku" "<Shift> " "<IgnoreShift><Control>("))
(define anthy-off-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "<IgnoreShift><Control>(")))
