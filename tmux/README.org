...
# DEPRECATED: Show all windows in the current session in a tree view. Think of
...
# DEPRECATED: Open double-clicked word. See tmux_mouse_word_handler.sh for more information.
